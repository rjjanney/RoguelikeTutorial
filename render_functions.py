...
def get_names_under_mouse(mouse, entities, fov_map):
    """Get name of entity under the mouse cursor."""
...
def render_bar(panel, x, y, total_width,
    ...
    """Render bar for keeping track of hp or other stuff."""
...
def render_all(con, panel, entities, player, game_map, fov_map, fov_recompute,
    ...
    """Draw all entities in list and game map."""
    ...
    for message in message_log.messages:
        ...
        libtcod.console_print_ex(
            panel, message_log.x, y, libtcod.BKGND_NONE, libtcod.LEFT,
            message.text)
        y += 1
...
def clear_all(con, entities):
    """Clear all entities so they can move without leaving trail."""
...
def clear_entity(con, entity):
    """Deal with individual entity clearing."""
