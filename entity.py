...
class Entity:
    ...
    def move_astar(self, target, entities, game_map):
        """Pathfinding algorithm known as A-star for 8 direction ai move.

        from http://www.roguebasin.com/index.php?title=
        Complete_Roguelike_Tutorial,_using_Python%2Blibtcod,_extras
        #A.2A_Pathfinding
        """
...
def get_blocking_entities_at_location(
    ...
    """Get blocking entities when trying to move to a destination."""
    for entity in entities:
        if entity.blocks and entity.x == destination_x\
                and entity.y == destination_y:
            return entity
