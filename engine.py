...
libtcod.renderer = 'RENDERER_OPENGL2'


def play_game(player, entities, game_map, message_log, game_state, con,
              panel, constants):
    """Start the game, after choosing from the main menu."""
    fov_recompute = True
    ...
    while not libtcod.console_is_window_closed():
        ...
        if move and game_state == GameStates.PLAYERS_TURN:
            ...
            for entity in entities:
                ...
                message_log.add_message(Message(
                    'There is nothing to pick up.', libtcod.yellow))
        ...
        for player_turn_result in player_turn_results:
                ...
                for equip_result in equip_results:
                    ...
                    if equipped:
                        message_log.add_message(
                            Message('You equipped the {0}'
                                    .format(equipped.name)))

                    if dequipped:
                        message_log.add_message(
                            Message('You dequipped the {0}'
            ...
            if xp:
                ...
                if leveled_up:
                    message_log.add_message(
                        Message('Your battle skills grow stronger! You '
                                'reached level {0}'
...
def main():
    """Main function of roguelike game engine."""
    ...
    while not libtcod.console_is_window_closed():
        ...
        if show_main_menu:
            ...
            if show_load_error_message and (new_game or
                                            load_saved_game or exit_game):
                show_load_error_message = False
            elif new_game:
                ...
                try:
                    ...
                    # if player dead, resurrect with half max hitpoints
                    if game_state == GameStates.PLAYER_DEAD:
                        player.char = '@'
