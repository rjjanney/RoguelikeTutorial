...
def inventory_menu(
        con, header, player, inventory_width,
...
def main_menu(con, background_image, screen_width, screen_height):
    ...
    libtcod.console_print_ex(
        ...
        libtcod.BKGND_NONE, libtcod.CENTER, 'By P.R.I.')
...
def level_up_menu(
        con, header, player, menu_width, screen_width, screen_height):
    """Menu to choose level up skill to increase (hp, attack or defense)."""
    options = [
...
def character_screen(
        player, character_screen_width, character_screen_height,
        screen_width, screen_height):
