...
class GameMap:
    """Class that hold properties and methods of the game map."""
    ...
    def make_map(self, max_rooms, room_min_size, room_max_size,
        ...
        """Make map with map making algorythm."""
        rooms = []
        num_rooms = 0
        ...
        for r in range(max_rooms):
            ...
            # random position without going out off the map
            ...
            for other_room in rooms:
                ...
                # this means there are no intersections, so
                # this room is valid
                ...
                if num_rooms == 0:
                    # if this is the first room, where player starts at
                    player.x = new_x
                    player.y = new_y
                else:
        ...
        # # Temporary reveal stairs
        # self.tiles[
        #     center_of_last_room_x][center_of_last_room_y].explored = True
    ...
    def place_entities(self, room, entities):
        """Place monsters and other entities in rooms."""
        ...
        for i in range(number_of_monsters):
            ...
            if not any([entity for entity in entities
                ...
                if monster_choice == 'orc':
                    ...
                    monster = Entity(
                        x, y, 'o', libtcod.desaturated_green, 'Orc',
        ...
        for i in range(number_of_items):
            ...
            if not any([entity for entity in entities
                ...
                if item_choice == 'healing_potion':
                    ...
                    item = Entity(
                        x, y, '[', libtcod.darker_orange, 'Shield',
                        equippable=equippable_component)
                    ...
                    item_component = Item(
                        ...
                        targeting_message=Message(
                            ...
                            'for the fireball, or right-click to cancel.',
                    ...
                    item_component = Item(
                        ...
                        targeting_message=Message(
                            'Left-click an enemy to confuse it, or right-click'
                            ' to cancel.', libtcod.light_cyan))
                    item = Entity(
                        x, y, '#', libtcod.light_pink,
                        'Confusion Scroll', render_order=RenderOrder.ITEM,
                        item=item_component)

                else:
                    item_component = Item(
                        use_function=cast_lightning, damage=40,
                        maximum_range=5)
                    item = Entity(
    ...
    def is_blocked(self, x, y):
        """Test if supplied block (x,y) can be moved through."""
    ...
    def next_floor(self, player, message_log, constants):
        """Generate new map, entities, floor number."""
